...
constructor(url: URL) {
    ...
    init {
        ...
        httpConnection.setRequestProperty("Authorization","Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJvc2FtYW0uY29tIiwidWlkIjo0NSwidHlwZSI6Im1lcmNoYW50IiwiaWF0IjoxNjA5MjY3ODg0LCJleHAiOjE2NDAzNzE4ODR9.ndCh2dINiROKo0tcQQjSSLO-2V50LZhIH2J3Ac-FGhE")
            ...
            try {
                ...
                if (status == HttpURLConnection.HTTP_OK) {
                   ...
                   // onFileUploadedListener?.onFileUploadingSuccess(response)
                    Log.e("dsdsdsd", "upload: $response" )
                } else {
                    Log.e("dsdsdsd", "upload: ${httpConnection.responseMessage}" )
